			...
			<div>
				<Row>
					...
					<Col span={20} className="container">
                        ...
                        <div>
                          <PcNewsImageBlock count={8} type="guonei" width="100%" cartTitle="当季最热活动" imageWidth="132px"/>
                          <PcNewsImageBlock count={16} type="yule" width="100%" cartTitle="活跃社团" imageWidth="132px"/>
                        </div>
